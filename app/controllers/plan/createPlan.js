        ...
        return new Promise((resolve, reject) => {
            ...
            try {
                ...
                let newPlan = new PlanModel({
                    ...
                    connectedHomeLimit : req.body.connectedHomeLimit,
                    connectedDeviceLimit : req.body.connectedDeviceLimit,
                    connectedRoomLimit  : req.body.connectedRoomLimit,
                    requestPerDayLimit : req.body.requestPerDayLimit,
